package U2T3_MethodsOverloading;
public class Adder {
    ...
    public Adder(String name, double increment, int counter) {
        this.name = name;
        this.counter = counter;
    ...
    public int addReversed(int num2, int num1) {
        return num1 + num2;
    }
    ...
    public int addTruncated(double num1, double num2) {
        int casted = (int) (num1 + num2);
        return casted;
    }
    ...
    public double addCoords(int x, int y, double z) {
        return x + y + z;
    }
